...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        table = $('#dataTables-users').DataTable({
            ...
            //"filter":false,        
            "ajax": '<?php echo $this->Html->url(array("controller" => "newsletters", "action" => "griddata", "admin" => TRUE)); ?>',
            "columns": [
                {"name": "Newsletter.id", "orderable": false, "searchable": false, 'width': '5%', 'sClass': 'text-center'},
                {"name": "Newsletter.email_address", 'width': '15%'},
                {"name": "Newsletter.created", 'width': '15%'},
                {"name": "Newsletter.common", "orderable": false, "searchable": false, 'width': '20%', 'sClass': 'text-center'},
            ],
            "order": [

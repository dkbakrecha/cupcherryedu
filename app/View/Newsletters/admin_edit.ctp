...
<div class="warper container-fluid">
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <?php
            echo $this->Form->create('Exam', array('class' => 'form-horizontal'));
            ...
            <div class="form-group">
                <label class="col-sm-2 control-label">FB Page</label>
                <div class="col-sm-7">
                    <?php
                    echo $this->Form->input('fb_page', array(
                        'class' => 'form-control',
                        'placeholder' => 'FB Page',
                        'label' => false,
                    ));
            ...
            <div class="form-group">
                ...
                <div class="col-sm-7">
                    <?php
                    echo $this->Form->input('logo_pic', array(
                        'class' => 'form-control',
                        'placeholder' => 'Logo_pic',
                        'label' => false,
                    ));
                    ?>
                </div>

<div class="warper container-fluid">
    <div class="panel panel-default">
        <div class="panel-heading">
            Practice Sets
            <a class='btn btn-primary btn-sm pull-right' href='<?php echo $this->Html->url(array('controller' => 'practices', 'action' => 'add', 'admin' => true)); ?>'>Add New Practice Set</a>
        </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        table = $('#dataTables-users').DataTable({
            ...
            //"filter":false,        
            "ajax": '<?php echo $this->Html->url(array("controller" => "practices", "action" => "index", "admin" => TRUE)); ?>',
            "columns": [
                {"name": "Practice.id", "orderable": false, "searchable": false, 'width': '5%', 'sClass': 'text-center'},
                {"name": "Practice.status", 'width': '15%'},
                {"name": "Practice.created", 'width': '15%'},
                {"name": "Practice.common", "orderable": false, "searchable": false, 'width': '20%', 'sClass': 'text-center'},
            ],
            "order": [
                [2, "desc"]//4 is here column name
            ],
            "language": {

<div class="warper container-fluid">
	...
	<div class="panel panel-default">
		<div class="panel-heading">
			<a class='btn btn-purple btn-sm pull-right' href='<?php echo $this->Html->url(array('controller' => 'test_types', 'action' => 'index',
	'admin' => true));
?>'>Back</a>
		</div>
...
<?php echo $this->Form->create('TestType', array("role" => "form")); ?>  
				...
				<?php
					...
					foreach($QuestionList as $question){ //pr($question);
						?>
						<tr>
							<td><input type="checkbox" class="case" name="data[questions][]" value="<?php echo $question['Question']['id']."_".$question['Answer']['id']."_".$question['Question']['sub_category_id'];  ?>"/></td>

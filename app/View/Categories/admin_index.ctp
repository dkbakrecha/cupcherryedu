<div class="warper container-fluid">
	<div class="panel panel-default">
		<div class="panel-heading">
			...
			if (!empty($parentCate))
			{
				echo "Categories under " . $parentCate['Category']['title'];
			}
			else
			{
				echo "Categories";
			...
			<a class='btn btn-success btn-sm pull-right' href='<?php echo $this->Html->url(array('controller' => 'categories', 'action' => 'add',
					'admin' => true, $cate_id)); ?>'>
				<?php
				if (!empty($parentCate))
				{
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        table = $('#dataTables-users').DataTable({
            ...
            //"filter":false,        
            "ajax": '<?php echo $this->Html->url(array("controller" => "categories", "action" => "categoryGrid", "admin" => TRUE,
					$cate_id)); ?>',
            "columns": [
                {"name": "Category.id", "orderable": false, "searchable": false, 'width': '5%', 'sClass': 'text-center'},
                {"name": "Category.title", 'width': '80%'},
                {"name": "Category.common", "orderable": false, "searchable": false, 'width': '15%', 'sClass': 'text-center'},
            ],
            "order": [

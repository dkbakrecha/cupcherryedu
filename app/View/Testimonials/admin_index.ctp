<div class="warper container-fluid">
    <div class="panel panel-default">
        <div class="panel-heading">
            Testimonials
            <a class='btn btn-purple btn-sm pull-right' href='<?php echo $this->Html->url(array('controller' => 'testimonials', 'action' => 'add', 'admin' => true)); ?>'>Add Testimonials</a>
        </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        table = $('#dataTables-users').DataTable({
            ...
            //"filter":false,        
            "ajax": '<?php echo $this->Html->url(array("controller" => "testimonials", "action" => "testimonialGrid", "admin" => TRUE)); ?>',
            "columns": [
                {"name": "Testimonial.id", "orderable": false, "searchable": false, 'width': '5%', 'sClass': 'text-center'},
                {"name": "Testimonial.name", 'width': '15%'},
                {"name": "Testimonial.email", 'width': '10%'},
                {"name": "Testimonial.testimonial_text", 'width': '45%'},
                {"name": "Testimonial.created", 'width': '10%'},
                {"name": "Testimonial.common", "orderable": false, "searchable": false, 'width': '20%', 'sClass': 'text-center'},
            ],
            "order": [
